...
const sages = {
    confucius: {
        ...
        responses: [
            "안녕하십니까. 논어에서 이르기를 **'학이시습지 불역열호(學而時習之 不亦說乎)'**라 하였습니다. 배우고 때로 익히니 또한 즐겁지 아니한가라는 이 말씀은 당신의 현재 고민조차 배움의 과정임을 일깨워줍니다. 당신이 겪는 시련은 군자로 나아가기 위한 소중한 수양의 기회입니다. 공자는 **'기욕립이립인 기욕달이달인(己欲立而立人 己欲達而達人)'**이라 하여, 내가 서고자 할 때 남을 먼저 세워주고 내가 이루고자 할 때 남을 먼저 이루게 하라고 가르쳤습니다. 타인과의 관계에서 오는 갈등은 결국 당신 내면의 인(仁)을 닦음으로써 해결될 수 있습니다. 조급해하지 말고 매일 조금씩 자신의 덕을 쌓아간다면, 머지않아 평안을 찾게 될 것입니다. 당신의 진실된 마음이 곧 길을 열어줄 것입니다.",
            "당신의 고민에 대해 **'기소불욕 물시어인(己所不欲 勿施於인)'**이라는 가르침을 드리고 싶습니다. 내가 당하고 싶지 않은 일을 남에게 하지 말라는 이 '서(恕)'의 정신이야말로 모든 인격 형성의 출발점입니다. 현재 겪고 계신 시련 속에서 혹시 자신이나 타인에게 가혹하지 않았는지 되돌아보십시오. 군자는 어려움 속에서도 자신의 도를 지키며, 결코 남을 탓하지 않는 법입니다. **'군자구저기 소인구저인(君子求諸己 小人求諸人)'**이라 하였으니, 문제의 원인을 밖이 아닌 안에서 찾아보십시오. 당신이 예의에 어긋나지 않게 행동한다면 세상의 모든 것이 당신의 편이 될 것입니다. 부디 마음의 평정을 유지하고 인의 도를 실천하는 데 힘쓰시기 바랍니다.",
            "지혜로운 사람은 당황하지 않고, 어진 사람은 근심하지 않으며, 용기 있는 사람은 두려워하지 않는다고 하였습니다. **'지자불혹 인자불우 용자불구(知者不惑 仁者不憂 勇者不懼)'**의 경지는 하루아침에 이루어지는 것이 아닙니다. 당신이 지금 느끼는 혼란은 아직 지혜와 덕이 온전히 쌓이지 않았기 때문일 수 있으나, 이를 자각하는 것만으로도 이미 훌륭한 시작입니다. 공자는 **'조문도 석사 가의(朝聞道 夕死 可矣)'**라 하여 아침에 도를 들으면 저녁에 죽어도 좋다고 하였습니다. 그만큼 진리를 향한 열망이 중요합니다. 당신의 고민을 학문의 동력으로 삼아, 묵묵히 자신의 자리를 지키며 도를 닦아 나가십시오. 반드시 밝은 빛이 비칠 날이 올 것이니 결코 포기하지 마십시오."
        ]
    },
    buddha: {
        name: "부처",
        title: "석가모니 세존(世尊)",
        responses: [
            "고통의 바다에서 방황하는 중생이여, **'일체유심조(一切唯心造)'**라는 진리를 깊이 새기십시오. 모든 현상은 오직 마음이 지어내는 것이며, 당신이 느끼는 괴로움 역시 실체가 없는 환상에 불과합니다. 금강경에서는 **'범소유상 개시허망(凡所有相 皆是虛妄)'**이라 하여, 무릇 형상이 있는 모든 것은 허망하다고 설했습니다. 당신이 집착하고 있는 그 고민의 끈을 잠시 내려놓아 보십시오. 마음이 고요해지면 거울에 비친 모습처럼 세상의 진실이 보일 것입니다. 당신 안에 이미 부처의 성품이 깃들어 있으니, 외부에서 답을 찾으려 하지 말고 내면의 평화를 일깨우는 수행에 정진하시기를 권합니다. 고요함 속에 모든 답이 있습니다.",
            "나고 죽는 것은 생겨나고 멸하는 법이니, 생멸이 멸하고 나면 적멸이 즐거움이 된다는 **'생멸멸이 적멸위락(생멸멸이 적멸위락)'**의 법문을 드립니다. 세상의 모든 만물은 변하기 마련이며 이를 **'제행무상(諸行無常)'**이라 합니다. 당신의 슬픔도, 기쁨도, 그리고 지금의 고민도 영원히 머물지 않고 흘러가는 구름과 같습니다. 흐르는 강물에 발을 두 번 담글 수 없듯이, 이 순간 또한 지나가면 다시 오지 않을 찰나입니다. 과거에 얽매이지 말고 미래를 두려워하지 마십시오. 오직 현재의 호흡에 집중하며 자신을 관찰할 때, 비로소 무거운 짐을 벗고 진정한 자유인이 될 수 있을 것입니다. 자애로운 마음으로 스스로를 보듬으십시오.",
...
function selectSage(id) {
    ...
    document.querySelectorAll('.sage-card').forEach(btn => {
        ...
        btn.classList.add('border-transparent', 'bg-stone-50');
    });
    const activeBtn = document.getElementById(`btn-${id}`);
    activeBtn.classList.remove('border-transparent', 'bg-stone-50');
    activeBtn.classList.add('border-amber-800', 'bg-amber-50');

    const chatMessages = document.getElementById('chat-messages');
    chatMessages.innerHTML = '';
    addMessage('system', `${sages[id].name}님과의 심층 상담이 시작되었습니다. 무엇이든 질문하십시오.`);
}
...
function addMessage(type, text, sage = null) {
    ...
    let content = '';
    if (type === 'user') {
        content = `<div class="bg-stone-900 text-white rounded-[2rem] px-8 py-4 max-w-[85%] shadow-xl border border-stone-800 text-lg">${text}</div>`;
    } else if (type === 'system') {
        content = `<div class="bg-stone-200 text-stone-600 text-[10px] font-black rounded-full px-6 py-2 mx-auto tracking-[0.2em] uppercase">${text}</div>`;
    } else {
        content = `
            <div class="flex flex-col gap-2 max-w-[85%]">
                <span class="text-xs font-black text-amber-900 ml-5 serif tracking-widest uppercase opacity-70">${sage.title}</span>
                <div class="bg-white border-2 border-stone-100 rounded-[2.5rem] px-10 py-8 shadow-2xl text-stone-800 leading-loose italic text-xl shadow-amber-900/5">
